...
const Content = () => {
  return (
    <div className='relative z-20 mx-auto flex max-w-6xl flex-col items-center justify-center px-4 py-24 md:px-8 md:py-36'>
      ...
      >
        <GlowingChip>
          Now Hiring Fire Protection Technicians and Helpers! Please send resume
          to vancouvervent@gmail.com!🎉
        </GlowingChip>
      </motion.div>
      <motion.h1
        initial={{
      ...
      >
        Get your kitchen hood certified and safe from grease fires
      </motion.p>
      <motion.div
        initial={{
          y: 25,
